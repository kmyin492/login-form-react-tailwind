  ...
  return (
    <div className="  flex min-h-screen items-center justify-center bg-gradient-to-b from-gay-100 to-green-500">
      ...
      <div className=" md:w-1/2  flex min-h-screen items-center justify-center ">
        <div className=" backdrop-blur-md border-t-1 border-b-1 border-gray-800  p-8 rounded-4xl shadow-lg ">
          ...
          <button
            className="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 active:bg-green-700 transition duration-200"
            onClick={handleLogin}
          >
            Login
          </button>
